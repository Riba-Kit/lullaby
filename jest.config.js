...
module.exports = {
	...
	// will use 10% of your CPU amount + 1 as the maximum worker number. maxWorkers: 2 will use a maximum of 2
	...
	moduleNameMapper: {
		'\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': `<rootDir>/__mocks__/${bundleVersion}/${testTarget}/fileMock.js`,
		'\\.(css|less|styl)$': `<rootDir>/__mocks__/${bundleVersion}/${testTarget}/styleMock.js`
	},
	...
	setupFiles: ['./jestGlobalsSetup.js'],

	// A list of paths to modules that run some code to configure or set up the testing framework before each test
	setupFilesAfterEnv: [
		'./jestEnzymeGlobalsSetup.js'
	],
	...
	testMatch: [
	//  `**/$${bundleVersion}/**/?(*.)+(spec|test).[tj]s?(x)`
		`**/?(*.)+(spec|test).[tj]s?(x)`
	],
	...
	// An array of regexp patterns that are matched against all source file paths before re-running tests in watch
	// mode watchPathIgnorePatterns: [],
